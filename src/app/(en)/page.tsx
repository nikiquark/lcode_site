    ...
    <main className="relative">
        ...
        <div className="flex flex-1 flex-col lg:flex-row justify-center items-center px-12 2xl:px-36 gap-x-20">
          ...
          <div className="flex flex-col gap-y-9 items-start">
            ...
            <p className="text-xl lg:text-2xl xl:text-3xl">
              A recently developed three-dimensional version of the quasistatic
              code LCODE has a novel feature that enables high-accuracy
              simulations of the long-term evolution of waves in plasma
      ...
      >
        <div className=" flex flex-col items-center justify-center text-center w-11/12 md:w-7/12 lg:text-2xl">
          ...
          <p className="mb-4">
            The support of the community is very important to us. That&apos;s
            why we put LCODE 3D into open access under BSD license. For
            programming LCODE 3D we used Python language to make it easier to
            understand. We also put a lot of effort into documenting the code.
            We are looking forward to community support.
          </p>
