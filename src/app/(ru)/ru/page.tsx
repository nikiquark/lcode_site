...
export default function L3D() {
  const links: PaperList = [
    ...
    },
    {
      ...
      links: [
        {
          text: 'Пучковый и плазменный солверы, подавление кластеризации электронов',
  ...
  const props = [
    {
      ...
      text: 'LCODE 2D, лежащий в основе LCODE 3D, был использован для моделирования большого количества задач и показал хорошее согласие с экспериментальными результатами и другими кодами',
    },
    {
      id: 2,
      title: 'Скорость',
      ...
      <section className="flex flex-col h-svh pt-20 bg-[color:rgb(var(--first-bg-rgb))]">
        <div className="flex flex-1 flex-col lg:flex-row justify-center items-center px-12 2xl:px-36 gap-x-20">
          ...
          <div className="flex flex-col gap-y-9 items-start">
            ...
            Недавно разработанная трехмерная версия квазистатического кода LCODE может с высокой точностью моделировать долговременную эволюцию волн в плазменных кильватерных ускорителях.
            </p>
            <Link
