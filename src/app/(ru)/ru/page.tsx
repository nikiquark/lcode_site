    ...
    <main className="relative">
      ...
      <section id="resourses" className="flex items-center justify-center py-10 md:py-32">
        <div className=" flex flex-col items-center justify-center text-center w-11/12 md:w-7/12 lg:text-2xl">
          ...
          <p className="mb-4">Поддержка сообщества очень важна для нас. Именно поэтому мы выложили LCODE 3D в открытый доступ под лицензией BSD. Для программирования LCODE 3D мы использовали язык Python, чтобы сделать его более понятным. Мы также приложили много усилий для документирования кода. Мы надеемся на поддержку сообщества. </p>
